...
const icons: { name: string; Component: ComponentType<{ size?: number }> }[] = [
  ...
  { name: "FahrplanAppIcon", Component: FahrplanAppIcon },
  { name: "FirebaseIcon", Component: FirebaseIcon },
  { name: "FlutterIcon", Component: FlutterIcon },
  { name: "FragespielAppIcon", Component: FragespielAppIcon },
  ...
  { name: "HabitsAppIcon", Component: HabitsAppIcon },
  { name: "InfoIcon", Component: InfoIcon },
  { name: "JavaIcon", Component: JavaIcon },
  { name: "KnowledgeBaseAppIcon", Component: KnowledgeBaseAppIcon },
